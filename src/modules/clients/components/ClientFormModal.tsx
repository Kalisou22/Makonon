  ...
  useEffect(() => {
    if (initialData) {
      reset({
        ...
        plafondTransaction: initialData.plafondTransaction,
      });
    } else {
      reset({
        nom: '',
      ...
      <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Input
            ...
            type="number"
            placeholder="1000000"
            {...register('plafondTransaction', { valueAsNumber: true })}
            error={errors.plafondTransaction?.message}
          />
        </div>
