  ...
  const columns = [
    {
      key: 'code',
      header: 'Code',
      render: (item: Agence) => <span className="font-mono text-sm font-medium text-blue-600">{item.code}</span>,
    },
    {
      key: 'nom',
      header: 'Nom',
      render: (item: Agence) => <span className="font-medium">{item.nom}</span>,
    },
    {
      key: 'responsable',
      header: 'Responsable',
      render: (item: Agence) => item.responsable || '-',
    },
    {
      key: 'telephone',
      header: 'Téléphone',
      render: (item: Agence) => item.telephone || '-',
    },
    {
      key: 'solde_cache',
      header: 'Solde',
    ...
    },
    {
      key: 'actif',
      header: 'Statut',
      render: (item: Agence) => <StatusBadge status={item.actif ? 'Actif' : 'Inactif'} variant={item.actif ? 'success' : 'danger'} />,
